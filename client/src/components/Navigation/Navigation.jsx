...
function Navigation() {
  ...
  // useEffect => // dispatch(addUserAc(localStorage.getItem('user_name')))

  // useEffect(() => {
  //   if (localStorage.getItem('user_name') !== null) {
  //     dispatch(addUserAc(localStorage.getItem('user_name')))
  //   }
  // }, [dispatch])
      ...
      <div className="collapse navbar-collapse col-4 navbar-nav mr-auto nav-item" id="left-header">
        ...
        {nameUser ?
          ...
          <>
            ...
            <Link className="nav-link" to="/logout"><i className="fa fa-user-times" aria-hidden="true" id="rightIcon"></i> <span className="sr-only"></span></Link>
