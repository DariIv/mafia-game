  ...
  return (
    <div className={style.rulesWrap}>
      ...
      <div className="accordion">
        ...
        <h3>Игра делится на два этапа: чередующиеся «день» и «ночь».</h3>
