    ...
    <div className={style.rulesWrap}>
      ...
      <div className={style.rulesBlocksWrap}>
        ...
        <div className={style.rulesListWrap}>
          ...
          <p>На утро ведущий объявляет, кто был убит, и начинается дневное обсуждение о том, кого необходимо вывести из игры. Затем вновь голосование и так до тех пор, пока одна из команд не победит.
          ...
          <p> В мафию играть можно и втроем. Но так будет неинтересно, игра быстро закончится. Наилучшее число игроков — 8-11, у такой компании будет время поиграть, аргументы каждого будут слышны и игра не затянется слишком долго.
